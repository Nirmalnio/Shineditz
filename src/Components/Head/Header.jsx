...
function Header() {
  ...
  const arrow = (
    ...
    >
      <path
        d="M12 16.5l-6-6 1.5-1.5 4.5 4.5 4.5-4.5 1.5 1.5z"
        fill="currentColor"
      />
    </svg>
  );
    ...
    <>
      <div className="headerDiv">
        <div>
          <Link to="/">
            {" "}
            <img src={Logo} alt="vistaeditz" className="headerlogo" />
          </Link>
          <br />
            ...
            <ul>
              <li className="dropdown">
                ...
                <div className="dropdown-content">
                  ...
                  <Link
                    ...
                    to="/services"
                    onClick={() =>
                      handleOptionClick("Color_Correction_Services")
                    }
                  >
                    Content 3
                  </Link>
              ...
              <li className="dropdown">
                ...
                <div className="dropdown-content">
                  ...
                  >
                    Flash/Ambient Editing{" "}
                  </Link>
                  <Link
                    className="drpdwnlink"
                    to="/realestate-services"
                    onClick={() =>
                      handleclickOption("Panorama Stitching/Editing")
                    }
                  >
                    Panorama Stitching/Editing{" "}
                  </Link>
                  <Link
                    className="drpdwnlink"
                    to="/realestate-services"
                  ...
                  <Link
                    ...
                    to="/realestate-services"
                    onClick={() =>
                      handleclickOption("Sky,Lawn and Pool Replacement")
                    }
                  >
                    Sky,Lawn and Pool Replacement{" "}
                  </Link>
                  <Link
                    className="drpdwnlink"
                    to="/realestate-services"
                  ...
                  >
                    Pro Image Enhancements
                  </Link>
                  <Link
                    className="drpdwnlink"
                    to="/realestate-services"
                    onClick={() =>
                      handleclickOption("Weather Removal/Day to Dusk")
                    }
                  >
                    Weather Removal/Day to Dusk{" "}
                  </Link>
                  <Link
                    className="drpdwnlink"
                    to="/realestate-services"
      ...
      <Offcanvas
        show={show}
        onHide={handleClose}
        /* responsive="lg" */ placement="end"
      >
        <Offcanvas.Header closeButton>
          <Offcanvas.Title>
            <img src={Logo} alt="vistaeditz" className="headerlogo"></img>
          </Offcanvas.Title>
        </Offcanvas.Header>
        <Offcanvas.Body>
          <div className="p-3 d-flex flex-column align-items-center mobdiv">
            -
            <Link to="/pricing">
              <div className="mob-options">Pricing</div>
            </Link>
            <Link to="/services">
              <div className="mob-options">Photo/ecommerce</div>
            </Link>
            <Link to="/realestate-services">
              <div className="mob-options"> Realestate-services</div>
            </Link>
            <Link to="/aboutus">
              <div className="mob-options">About US</div>
            </Link>
            <Link to="/contact" style={{ textDecoration: "none" }}>
              <div className="contactus-btn2">Contact us</div>
            </Link>
          </div>
        </Offcanvas.Body>
      </Offcanvas>
